...
| [ADR-009](./009-v0.5-roadmap-adjustment.md) | v0.5 版本规划调整 | 📋 提议 | 2026-02-03 | 版本规划 |
...
**路线图**:
1. 📋 [ADR-009: v0.5 版本规划调整](./009-v0.5-roadmap-adjustment.md) - **当前版本**
2. 📋 [完整路线图](../plans/mcda-core/roadmap-v0.5-to-v1.0.md) - v0.5 → v1.0
