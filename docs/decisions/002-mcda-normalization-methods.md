...
### 3. 方法实现优先级（architect agent 审查后调整）
...
| 排名 | 方法 | 热度 | 难度 | 价值 | 依赖 | **总分** | 类别 | **新阶段** | 变化 |
|------|------|------|------|------|------|----------|------|-----------|------|
| 🥇 1 | **MinMax** | 5.0 | 5.0 | 5.0 | 5.0 | **5.00** | 基础 | **v0.2** | - |
| 🥈 2 | **Vector** | 4.5 | 5.0 | 5.0 | 5.0 | **4.85** | 统计 | **v0.2** | **↑ 依赖升级** |
| 🥉 3 | **Z-Score** | 4.0 | 4.5 | 4.5 | 4.0 | **4.25** | 统计 | **v0.3** | - |
| 4 | **Sum** | 4.0 | 5.0 | 4.0 | 3.5 | **4.15** | 基础 | **v0.3** | - |
| 5 | **Inverse** | 4.5 | 5.0 | 4.0 | 3.0 | **4.10** | 基础 | **v0.3** | **↓ 降级** |
| 6 | **Max** | 3.0 | 5.0 | 3.5 | 3.5 | **3.50** | 基础 | **v0.4** | **↓ 降级** |
| 7 | **Logarithmic** | 3.0 | 4.0 | 4.0 | 3.0 | **3.35** | 统计 | **v0.4+** | **↓ 降级** |
| 8 | **Sigmoid** | 2.5 | 3.0 | 4.5 | 2.5 | **3.05** | 高级 | **v0.4+** | - |
| 9 | **Threshold** | 3.5 | 4.0 | 3.0 | 2.0 | **3.00** | 高级 | **v0.4** | **↓ 降级** |

**关键变化说明**:
- **Vector 升级**: TOPSIS 必需，架构依赖从 4.5 → 5.0
- **Inverse 降级**: 可作为 MinMax 的 direction 参数实现，无需独立方法
- **Max 降级**: 与 MinMax 功能重复
- **Threshold 降级**: 阶梯函数丢失精度，用户价值低

### 4. 分阶段实施路线图（architect agent 审查后调整）

#### v0.2: 基础标准化层（2 天，1.5 人日）⭐ MVP 核心

**目标**: 支持 MVP 必需的标准化方法

| 方法 | 优先级 | 工作量 | 说明 |
|------|--------|--------|------|
| **MinMax** | P0 | 0.5 人日 | 最通用，已有基础 |
| **Vector** | P0 | 1 人日 | TOPSIS 必需，独立实现 |

**总工作量**: **1.5 人日**

#### v0.3: 统计标准化层（1 周，3 人日）

| 方法 | 优先级 | 工作量 | 说明 |
|------|--------|--------|------|
| **Z-Score** | P0 | 2 人日 | 统计学标准，处理异常值 |
| **Sum** | P1 | 0.5 人日 | 比例型数据 |
| **Inverse** | P2 | 0.5 人日 | MinMax 变体，可合并实现 |

**总工作量**: **3 人日**

#### v0.4: 高级标准化层（1 周，5 人日）

| 方法 | 优先级 | 工作量 | 说明 |
|------|--------|--------|------|
| **Max** | P3 | 0.5 人日 | 与 MinMax 功能重复 |
| **Threshold** | P3 | 1.5 人日 | 丢失精度，场景有限 |
| **Logarithmic** | P3 | 1.5 人日 | 偏态分布场景少 |
| **Sigmoid** | P3 | 1.5 人日 | 参数调优复杂 |

**总工作量**: **5 人日**

**标准化方法总计**: **9.5 人日** (原 27 人日，节省 **17.5 人日**)
...
**状态**: ✅ 已批准（优先级已调整）
**总工作量**: 9.5 人日 (原 27 人日，优化节省 17.5 人日)
